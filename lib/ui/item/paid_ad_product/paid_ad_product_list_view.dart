    ...
    return ChangeNotifierProvider<PaidAdProductProvider?>(
        ...
        create: (BuildContext context) {
          ...
          Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.medium,
            ...
            paidAdItemProvider!.productPaidAdParameterHolder.lat =   position.latitude.toString();
            paidAdItemProvider!.productPaidAdParameterHolder.lng =   position.longitude.toString();
